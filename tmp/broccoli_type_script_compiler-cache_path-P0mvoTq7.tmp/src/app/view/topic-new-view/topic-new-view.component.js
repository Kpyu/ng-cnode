...
var TopicNewViewComponent = (function () {
    ...
    TopicNewViewComponent = __decorate([
        core_1.Component({
            ...
            templateUrl: 'topic-new-view.component.html',
            styleUrls: ['topic-new-view.component.css']
        }), 
        __metadata('design:paramtypes', [])
    ], TopicNewViewComponent);
    return TopicNewViewComponent;
}());
exports.TopicNewViewComponent = TopicNewViewComponent;
//# sourceMappingURL=topic-new-view.component.js.map